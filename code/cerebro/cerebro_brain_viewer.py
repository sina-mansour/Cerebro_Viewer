...
class Cerebro_brain_viewer:
    ...
    def load_GIFTI_cortical_surface_models(self, left_surface_file, right_surface_file):
        ...
        This method loads a GIFTI cortical surface model from two separate GIFTI surface files
        for the left and right hemispheres, respectively. The loaded cortical surface model is
        then stored in the object's internal data structure.
        ...
        Returns:
            dict: A dictionary representing the loaded cortical surface model. The dictionary has the following keys:
    ...
    def load_template_GIFTI_cortical_surface_models(self, template_surface="inflated"):
        ...
        This method loads a GIFTI cortical surface model by using a template surface name.
